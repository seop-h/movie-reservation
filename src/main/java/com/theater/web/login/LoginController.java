...
public class LoginController {
    ...
    public ResponseResult logout(HttpServletRequest request) throws IllegalAccessException {
        ...
        if (session == null || session.getAttribute(SessionConst.LOGIN_MEMBER_ID) == null) { //로그인하지 않은 사용자가 로그아웃 요청 시 오류 반환
            throw new IllegalAccessException("잘못된 요청입니다. 로그인하지 않은 사용자가 로그아웃 요청을 하였습니다.");
        }
